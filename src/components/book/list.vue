    ...
    <el-col :span="24" class="warp-main" v-loading="loading" element-loading-text="拼命加载中">
      ...
      <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
        <el-form :inline="true" :model="filters">
          ...
          <el-form-item>
            <el-button type="primary" @click="showDynamForm">动态表单</el-button>
          </el-form-item>
          <el-form-item>
            <el-button type="primary" @click="showDynamForm02">动态表单02</el-button>
          </el-form-item>
        </el-form>
      ...
      <!--新增界面-->
      <el-dialog title="新增界面" :visible.sync="addFormVisible" :close-on-click-modal="false">
        <add></add>
      </el-dialog>
      <!--编辑界面-->
      <el-dialog title="修改界面" :visible.sync="editFormVisible" :close-on-click-modal="false">
        <edit :id="bookId" ></edit>
      </el-dialog>
      <!--动态界面-->
      <el-dialog title="动态界面" :visible.sync="dynamFormVisible" :close-on-click-modal="false">
        <add-from></add-from>
      </el-dialog>

      <el-dialog title="动态界面02" :visible.sync="dynamForm02Visible" :close-on-click-modal="false">
...
<script>
  ...
  import ElFormRenderer from '../dynamicform02/'
  import formData from '@/data/formData.js'
  import addFrom from './addForm'

  export default{
    components:{add, edit, ElFormRenderer, addFrom
    },
    data(){
      return {
        filters: {
        ...
        addLoading: false,
        bookId:'',
        dynamFormVisible:false,
        dynamForm02Visible:false,
        content:formData.form2
        
      }
    },
    methods: {
      showDynamForm(){
        this.dynamFormVisible = true;
      },
      showDynamForm02(){
        this.dynamForm02Visible = true;
      },
